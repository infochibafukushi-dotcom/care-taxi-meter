...
import { formatCaseDateTime, formatCaseOperationDateTime, getActualMeterMode, isPreFixedFarePassengerChangeCase, meterModeLabels } from '../utils/caseRecords'
              ...
              <PreFixedFarePassengerChangeDetailSection
                completionStatusLabel={
                  caseRecord.status === 'completed_with_passenger_change'
                    ? formatFixedFareCompletionStatus(caseRecord.status)
                    : null
                }
                completionReasonLabel={
                  caseRecord.completionReason
                    ? formatFixedFareCompletionReason(caseRecord.completionReason)
                    : null
                }
                fareMode={caseRecord.fareMode}
